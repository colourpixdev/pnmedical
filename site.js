...
function renderHomeProductPreview() {
    return `<section class="section section--tight product-preview"><div class="container"><div class="section-heading"><div><span class="eyebrow">Featured Range</span><h2>Start with the touch-free system and its refill formats.</h2></div><p>The products area is now its own page, with detailed sections for dispenser hardware and refill consumables.</p></div><div class="preview-links"><a class="preview-link angular-card" href="products.html"><strong>Touch Free Dispensers</strong><span>Plastic and stainless steel systems for shared environments.</span></a><a class="preview-link angular-card" href="products.html"><strong>1 Litre Refill Bags</strong><span>Waterless isopropanol sanitiser with tested 99.9% efficacy claims.</span></a></div></div></section>`;
}
